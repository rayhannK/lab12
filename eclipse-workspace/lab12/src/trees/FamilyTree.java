...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        ArrayList<TreeNode> collectAncestorsToList()
        {
            ...
            TreeNode traverseParent = this.parent;
            while (traverseParent != null)
            {
            	ancestors.add(traverseParent);
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Missing colon, buddy");
		...
		else
		{
			...
			//use parent as string if that doesn't work
			if (parentNode == null)
			{
				throw new TreeException("Can't find that node, buddy");
			}
